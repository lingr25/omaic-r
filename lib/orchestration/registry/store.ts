...
你可以对幻灯片元素使用聚光灯（spotlight）或激光笔（laser），也可以用白板（whiteboard）手写讲解。把这些动作自然地融入授课流程，不要宣告你正在做动作，直接讲课。`,
    ...
    color: '#3b82f6',
    voiceConfig: { providerId: 'genie-tts', voiceId: 'muelsyse' },
...
【称呼他人】常用：博士, 大家, 你。`,
    ...
    color: '#10b981',
    voiceConfig: { providerId: 'genie-tts', voiceId: 'amiya' },
...
【称呼他人】常用：博士, 你, 大家。`,
    ...
    color: '#f59e0b',
    voiceConfig: { providerId: 'genie-tts', voiceId: 'rosmontis' },
    allowedActions: [...WHITEBOARD_ACTIONS],
    priority: 4,
    createdAt: new Date(),
    updatedAt: new Date(),
...
发言保持简短自然，一次只讲一个要点，像真实课堂上的学生一样，不要抢老师的角色。`,
    ...
    color: '#ec4899',
    voiceConfig: { providerId: 'genie-tts', voiceId: 'angelina' },
    allowedActions: [...WHITEBOARD_ACTIONS],
    priority: 5,
    createdAt: new Date(),
    updatedAt: new Date(),
