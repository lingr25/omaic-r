    ...
    try {
      ...
      if (list.length > 0) {
        ...
        for (const course of list) {
          if (!slides[course.id] && course.previewSlide) {
            slides[course.id] = structuredClone(course.previewSlide);
          }
        }
    ...
    <div className="min-h-[100dvh] w-full bg-gradient-to-b from-slate-50 to-slate-100 dark:from-slate-950 dark:to-slate-900 flex flex-col items-center p-4 pt-16 md:p-8 md:pt-16 overflow-x-hidden">
      ...
      >
        ...
        <div className="relative" data-pro-morph="lockup">
          <motion.img
            src="/logos/rhodes-island-horizontal.svg"
            alt="OMAIC-R"
          ...
          <motion.img
            ...
            className="hidden dark:block h-12 md:h-16 mb-2 -ml-2 md:-ml-3"
          />
        ...
        >
          <div
            ...
            className="w-full rounded-2xl border border-border/60 bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl shadow-xl shadow-black/[0.03] dark:shadow-black/20 transition-shadow focus-within:shadow-2xl focus-within:shadow-teal-500/[0.06]"
          >
                              ...
                              overlay={
                                <>
                                  ...
                                  {isSearching && classroom.folderId && (
                                    <span className="absolute bottom-2 left-2 z-10 inline-flex items-center gap-1 rounded-md bg-teal-500/80 px-1.5 py-0.5 text-[10px] font-medium text-white backdrop-blur-sm pointer-events-none">
      ...
      {!open && (
        ...
        >
          <div className="shrink-0 relative">
            <div className="size-8 rounded-full overflow-hidden ring-[1.5px] ring-border/30 group-hover:ring-teal-400/60 dark:group-hover:ring-teal-400/40 transition-all duration-300">
          ...
          >
            <div className="rounded-2xl bg-white/95 dark:bg-slate-800/95 backdrop-blur-sm ring-1 ring-black/[0.04] dark:ring-white/[0.06] shadow-[0_1px_8px_-2px_rgba(0,0,0,0.06)] dark:shadow-[0_1px_8px_-2px_rgba(0,0,0,0.3)] px-2.5 py-2">
              ...
              >
                ...
                >
                  <div className="size-8 rounded-full overflow-hidden ring-[1.5px] ring-teal-300/70 dark:ring-teal-500/40 transition-all duration-300">
                    <img src={avatar} alt="" className="size-full object-cover" />
                  </div>
                  <motion.div
                    initial={{ scale: 0 }}
                ...
                <div className="flex-1 min-w-0">
                  {editingName ? (
                    <div className="flex items-center gap-1.5" onClick={(e) => e.stopPropagation()}>
                      ...
                      <button
                        onClick={commitName}
                        className="shrink-0 size-5 rounded flex items-center justify-center text-teal-500 hover:bg-teal-100 dark:hover:bg-teal-900/30"
                      >
                        ...
                        {AVATAR_OPTIONS.map((url) => (
                          <button
                            ...
                            className={cn(
                              ...
                              avatar === url
                                ? 'ring-2 ring-teal-400 dark:ring-teal-500 ring-offset-0'
                        ...
                        <label
                          className={cn(
                            ...
                            isCustomAvatar(avatar)
                              ? 'ring-2 ring-teal-400 dark:ring-teal-500 ring-offset-0 border-teal-300 dark:border-teal-600 bg-teal-50 dark:bg-teal-900/30'
  ...
  return (
    ...
    >
      ...
      >
        {slide && thumbWidth > 0 ? (
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="size-12 rounded-2xl bg-gradient-to-br from-teal-100 to-blue-100 dark:from-teal-900/30 dark:to-blue-900/30 flex items-center justify-center">
      ...
      <div className="mt-2.5 px-1 flex items-center gap-2">
        <span className="shrink-0 inline-flex items-center rounded-full bg-teal-100 dark:bg-teal-900/30 px-2 py-0.5 text-[11px] font-medium text-teal-600 dark:text-teal-400">
        ...
        {editing ? (
          <div className="flex-1 min-w-0" onClick={(e) => e.stopPropagation()}>
            <input
              ...
              className="w-full bg-transparent border-b border-teal-400/60 text-[15px] font-medium text-foreground/90 outline-none placeholder:text-muted-foreground/40"
            />
          </div>
        ) : (
          <Tooltip>
