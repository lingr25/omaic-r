...
export function Roundtable({
  ...
  const referencePill = elementReferencePill ? (
    <div
      ...
      className="pointer-events-auto flex max-w-[min(520px,calc(100vw-3rem))] items-center gap-2 rounded-full border border-teal-200 bg-white/95 px-3 py-1.5 text-xs shadow-lg backdrop-blur dark:border-teal-700 dark:bg-gray-900/95"
      onClick={(event) => event.stopPropagation()}
    >
      <Quote className="h-3.5 w-3.5 shrink-0 text-teal-600 dark:text-teal-400" />
      <span className="shrink-0 font-semibold text-teal-700 dark:text-teal-300">
                  ...
                  <button
                    ...
                    className={cn(
                      ...
                      isSendCooldown
                        ...
                        : 'bg-teal-600 hover:bg-teal-700 shadow-[0_4px_16px_rgba(147,51,234,0.3)]',
                    )}
                  >
                    {isSendCooldown ? (
              ...
              >
                <div className="flex items-center gap-4 bg-white/70 dark:bg-black/60 backdrop-blur-xl rounded-full px-5 py-3 shadow-[0_8px_32px_rgba(0,0,0,0.08)] dark:shadow-[0_8px_32px_rgba(0,0,0,0.4)] border border-gray-200/60 dark:border-white/10">
                  ...
                  <div className="flex items-center gap-0.5 h-8">
                    <VoiceWaveformBars barClassName="bg-gradient-to-t from-teal-400 to-indigo-400" />
                  </div>
                  <span className="text-[11px] font-semibold tracking-wider text-teal-600 dark:text-teal-300 uppercase">
                  ...
                  >
                    <div className="relative w-12 h-12 rounded-full bg-gradient-to-br from-teal-600 to-indigo-700 shadow-[0_4px_20px_rgba(147,51,234,0.3)] flex items-center justify-center group-hover:scale-105 transition-transform duration-300 border border-white/20">
                      <Mic className="w-5 h-5 text-white" />
                    </div>
                    <div className="absolute inset-0 rounded-full border-2 border-teal-500 opacity-40 animate-[ping_2s_ease-in-out_infinite]" />
                  </button>
                </div>
              </motion.div>
            )}
                      ...
                      <div className="flex items-center gap-[3px]">
                        {[0, 1, 2].map((i) => (
                          <motion.div
                            ...
                            className="w-[3px] h-[3px] rounded-full bg-teal-400"
                          />
                        ))}
                      </div>
                    </div>
                        ...
                        className={cn(
                          ...
                          isCueUser
                            ...
                            : activeRole === 'user' || isInputOpen
                              ? 'border-teal-500 shadow-[0_0_6px_rgba(168,85,247,0.3)]'
                              : 'border-gray-300/40 dark:border-white/20 group-hover:border-teal-400/50',
                        )}
                      />
                      <div className="w-8 h-8 rounded-full bg-gray-200 dark:bg-gray-800 overflow-hidden relative z-10 text-lg">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <div className="min-w-0">
                            ...
                            <span
                              ...
                              style={{
                                backgroundColor: teacherConfig?.color || '#14b8a6',
                              }}
                            >
              ...
              {isInputOpen && (
                ...
                >
                  <div
                    ...
                    className="relative w-fit max-w-[85%] sm:max-w-[65%] min-w-[200px] sm:min-w-[300px] bg-white/90 dark:bg-gray-800/90 backdrop-blur-md p-2 pr-2 rounded-2xl rounded-br-none shadow-2xl border border-teal-200 dark:border-teal-700 flex items-end gap-2 ring-1 ring-teal-100/50 dark:ring-teal-800/50"
                  >
                ...
                >
                  <div className="flex flex-col-reverse items-end gap-1 mr-[-10px] relative z-20">
                    <div className="flex items-center gap-0.5 h-8 px-2 py-1.5 bg-white/80 dark:bg-gray-800/80 backdrop-blur-md rounded-xl border border-teal-100 dark:border-teal-800 shadow-sm">
                      <VoiceWaveformBars barClassName="bg-gradient-to-t from-teal-500 to-indigo-600 dark:from-teal-400 dark:to-indigo-500" />
                    </div>
                    <motion.div
                    ...
                    >
                      ...
                      {bubbleRole !== 'user' &&
                        ...
                        (() => {
                          ...
                          const barsColor =
                            bubbleRole === 'agent' ? 'bg-blue-500' : 'bg-teal-500';
                          ...
                          return (
                            <div className="absolute right-2.5 bottom-2.5 p-1.5 rounded-full bg-gray-50/80 dark:bg-gray-700/80 group-hover/bubble:bg-teal-100 dark:group-hover/bubble:bg-teal-900/50 transition-all duration-300">
                              {isDiscussionPaused ? (
                                ...
                                <Play className="w-3.5 h-3.5 text-amber-500 dark:text-amber-400 group-hover/bubble:text-teal-600 dark:group-hover/bubble:text-teal-400 ml-0.5" />
                              ) : (
                                <>
