      ...
      <DialogContent className="sm:max-w-[400px]">
        ...
        <div className="py-2">
          ...
          <input
            ...
            maxLength={80}
            className="mt-1.5 w-full rounded-lg border border-border bg-background px-3 py-2 text-[14px] outline-none focus:ring-2 focus:ring-teal-400/40 focus:border-teal-400"
          />
