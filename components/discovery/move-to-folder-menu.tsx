    ...
    <DropdownMenu>
      ...
      >
        ...
        >
          ...
          {currentFolderId === undefined && <Check className="size-3.5 text-teal-500" />}
        </DropdownMenuItem>
        ...
        {folders.map((f) => (
          ...
          >
            ...
            {currentFolderId === f.id && <Check className="size-3.5 text-teal-500 shrink-0" />}
          </DropdownMenuItem>
        ))}
