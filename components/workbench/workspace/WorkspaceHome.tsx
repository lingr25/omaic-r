  ...
  return (
    ...
    >
      ...
      <div className="flex h-12 shrink-0 items-center justify-between px-4 md:hidden">
        <img src={brand.logoSrc} alt={brand.productName} className="h-5 w-auto dark:hidden" />
        <img
            ...
            >
              {isDesktop && !brand.logoHasWordmark ? (
                ...
                <img
                  ...
                  className="ws-hero-logo dark:hidden"
                />
                <img
                  src="/logos/rhodes-island-horizontal-dark.svg"
                  alt={brand.productName}
                  data-testid="pro-workspace-hero-logo-dark"
                  className="ws-hero-logo hidden dark:block"
                />
              )}
